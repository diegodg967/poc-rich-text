...
function BlockOptionsDropdownList({
  ...
  useEffect(() => {
    ...
    const handle = (event: MouseEvent) => {
      ...
      if (!dropDown.contains(target as Node) && !toolbar.contains(target)) {
  ...
  return (
    <div className="dropdown" ref={dropDownRef}>
      ...
      <button className="item" onClick={formatLargeHeading}>
        ...
        <span className="text">Large Heading (H1)</span>
        {blockType === "h1" && <span className="active" />}
      </button>
      <button className="item" onClick={formatSmallHeading}>
        <span className="icon small-heading" />
        <span className="text">Small Heading (H2)</span>
...
export default function ToolbarPlugin() {
  ...
  const onCodeLanguageSelect: React.ChangeEventHandler<HTMLSelectElement> =
    useCallback(
      (e) => {
        editor.update(() => {
  ...
  return (
    <div className="toolbar" ref={toolbarRef}>
      <button
        disabled={!canUndo}
        onClick={() => {
          editor.dispatchCommand(UNDO_COMMAND, {} as never);
        }}
      ...
      <button
        disabled={!canRedo}
        onClick={() => {
          editor.dispatchCommand(REDO_COMMAND, {} as never);
        }}
